...
.btn-link {
   ...
   <br>
   <h2 style="color:#1c2331; font-family:Arial; text-align:center; ">Inscrição de Voluntárias</h2>
   <h4 style="margin-left: 15%; margin-right: 15%; font-size: 1.25rem; color: black; margin-top:2%; text-align:center;">
   Se inscreva para orientar as vítimas de violência doméstica!</h4>
   <form class="form-horizontal" action="crud/cadastrocrudV.php" method="POST">
            <fieldset>
            ...
            <!-- Nome-->
            <div class="form-group">
            <label class="col-md-2 control-label" for="Nome" style="color: black;">Nome<h11>*</h11></label>  
            <div class="col-md-12">
            ...
            <!-- Sobrenome -->
            <div class="form-group">
            <label class="col-md-2 control-label" for="Nome" style="color: black;">Sobrenome<h11>*</h11></label>  
            <div class="col-md-12">
            ...
            <div class="col-md-12">
         <!--   <input id="cpf" name="cpf" placeholder="" class="form-control input-md" required="" type="text" maxlength="14" onkeydown="javascript: fMasc( this, mCPF );"> -->
            ...
            <!-- Profissão -->
            <div class="form-group">
            <label class="col-md-2 control-label" for="Nome" style="color: black;">Profissão<h11>*</h11></label>  
            <div class="col-md-12">
          ...
          <option value="Direito">Direito</option>
            ...
            <!-- <input id="prof" name="prof" placeholder="" class="form-control input-md" required="" type="text"> -->
            </div>
            </div>
            <!-- Atestado de Mátricula 
            <div class="form-group">
            <label class="col-md-2 control-label" for="Nome" style="color: black;">Atestado de Mátricula<h11>*</h11></label> 
            <p style="margin-left:4%; color:#777777;">Atenção! Você só pode ser voluntária se estiver cursando o último semestre!</p>
            <div class="col-md-12">
            ...
            <!-- Histórico Escolar 
            <div class="form-group">
            <label class="col-md-2 control-label" for="Nome" style="color: black;">Histórico Escolar (Faculdade)<h11>*</h11></label> 
            <div class="col-md-12">
            <input type="file" id="myFile" name="filename" >
            </div>
            </div>  -->
            ...
            <!-- Email -->
            <div class="form-group">
            <label class="col-md-2 control-label" for="prependedtext" style="color: black;">Email <h11>*</h11></label>
            <div class="col-md-12">
    ...
    <!-- <p style="color: #777777;">Sua senha deve contar letras MAIÚSCULAS, MINÚSCULAS e NÚMEROS, apenas 8 caracteres<h11>*</h11></p> -->
...
g) Em hipótese de tratamento de dados pessoais sensíveis, assegurar que o tratamento será único e exclusivamente para cumprir com a finalidade ajustada e de modo a possibilitar a perfeita execução do contrato.”
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
            ...
            <div class="form-group">
            <div class="col-md-8">
                <button id="Cadastrar" name="Cadastrar" class="btn btn-dark" type="Submit">Continuar</button>
            </div>
            </div>
</fieldset>
</form>
