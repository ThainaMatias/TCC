...
.navbar-expand-md .navbar-nav .nav-link {
    ...
    <nav class="navbar navbar-expand-md navbar  fixed-top">
        ...
        <a class="navbar-brand" href="index.php"><img src="imagens/logotest2-2.png"></a>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="relatofeito.php">Relatos</a>
          </li>
        ...
        <li class="nav-item dropdown">
              ...
              Cadastre-se / Login
                ...
                <div class="dropdown-menu">
                <a class="dropdown-item" href="login.php">Login/ Usuárias</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="http://localhost/TCC-Site/mibew/operator/login">Área Voluntárias</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="cadastrousuario.php">Cadastro </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="cadastrovoluntario.php">Inscrição de Voluntárias</a>
                </div>
            </li> 
