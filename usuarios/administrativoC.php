<?php
	...
	$result_recado_bd = "SELECT * FROM mensagem";
	...
	<head>
		...
		<div class="container theme-showcase" role="main">
			<div class="page-header">
				<h2 style="margin-top: 2%;">Lista de Mensagens</h2>
			</div>
			<br>
			<div class="row">
