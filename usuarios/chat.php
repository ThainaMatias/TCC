...
<h2 style="color:#1c2331; font-family:Arial; text-align:center; margin-top: 0.3%;">Contate nossas Psicólogas</h2>
	...
	<?php
			if($_SERVER['REQUEST_METHOD']=='POST'){
				...
				if(isset($_SESSION['ultima_request']) && $_SESSION['ultima_request'] == $request){
					...
					if(isset($_POST['usuario'])){
						...
						$recado = $_POST['recado'];
						$result_recado = "INSERT INTO mensagem (nome, msg) VALUES ('$usuario', '$recado')";						
		...
		<div class="container theme-showcase" role="main">
			<div class="page-header">
				...
				<?php
					$result_recado_bd = "SELECT * FROM mensagem ORDER BY id DESC";
